...
func RegisterBuiltins(r *Registry, workdir string) {
	...
	r.Register(&PatchTool{AllowDirs: allow})
	r.Register(&GitTool{Workdir: abs})
	...
	r.Register(&OpencodeTool{Dir: abs, AllowDirs: allow})
	r.Register(&TranscribeTool{AllowDirs: allow})
